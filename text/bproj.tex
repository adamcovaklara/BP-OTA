...
\end{figure}
\noindent Lze použít i zapojení ze sekce \ref{sec:ODV} s uzemněným kapacitorem a odporem, avšak při této realizaci dochází v amplitudové charakteristice k překmitu. Proto bylo zvoleno řešení zmíněné výše.
