...
\begin{align}
H(j\omega) = \frac{H_0 \omega_0 ^2}{(j\omega)^2 + \frac{\omega _0}{Q}(j\omega) + \omega _0 ^2}.
\end{align}
...
\begin{align}
H(j\omega) = \frac{H_{\infty} (j\omega) ^2}{(j\omega)^2 + \frac{\omega _0}{Q}(j\omega) + \omega _0 ^2}.
\end{align}
...
\begin{align}
H(j\omega) = \frac{H_{B} \frac{\omega _0}{Q} (j\omega) }{(j\omega)^2 + \frac{\omega _0}{Q}(j\omega) + \omega _0 ^2}.
\end{align}
