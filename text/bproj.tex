...
\begin{figure}[H]
\centering
\includegraphics[scale=0.8]{RlcHiPass.png}
\caption{Horní propust \cite{11}}
\end{figure}
\noindent Mezní frekvence a činitel jakosti tohoto obvodu byly spočítány jako 
\begin{align}
\omega _c &= \frac{1}{2 \pi \sqrt{LC}}\\
Q &= \frac{1}{2 \zeta},
\end{align}
\noindent kde $\zeta$ je relativní útlum vyjádřený z přenosové funkce
\begin{align}
H(s) = \frac{s^2}{s^2 + 2 \zeta (2 \pi \omega _c)s + (2 \pi \omega _c)^2}
\end{align}
...
\caption{Zapojení pásmové propusti \cite{13}}
\end{figure}
...
\MapleOutput{C2 = 3.8861*10^{-6}, L1 = 2.2799*10^{-5}, L2 = 1.0185*10^{-6}, }
\MapleOutput{Rs1 = 0.2292, Rs2 = 0.010239]}
...
\caption{Modulová frekvenční charakteristika z přenosu LC struktury}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[scale=0.6]{modul2.png}
\caption{Modulová frekvenční charakteristika z přenosu LC struktury se sériovými rezistory k induktorům}
\end{figure}
\noindent Vyčíslením v $100*10^3*2 \pi$ Hz byl obdržen útlum -20 dB.\\
...
\MapleOutput{L3=subs(eval(elems\_BPQ[3][elements]),L1), L4=subs(eval(elems\_BPQ[3][elements]),L2),} \MapleOutput{C3=subs(eval(elems\_BPQ[3][elements]),C1), C4=subs(eval(elems\_BPQ[3][elements]),C2),}
\MapleOutput{C5=subs(eval(elems\_BPQ[4][elements]),C1),L5=subs(eval(elems\_BPQ[4][elements]),L1),}
\MapleOutput{R1=subs(eval(elems_BPQ[1][elements]),Rs1),R2=subs(eval(elems_BPQ[2][elements]),Rs1),}\MapleOutput{R3=subs(eval(elems_BPQ[3][elements]),Rs1),R4=subs(eval(elems_BPQ[3][elements]),Rs2),}\MapleOutput{R5=subs(eval(elems_BPQ[4][elements]),Rs1),}
\MapleOutput{R0=eval(elems\_BPQ)[R1], Rz=eval(elems\_BPQ)[R2];}
\MapleOutput{ele\_BP := { C1 = 1.18426*10^{-7}  , C2 = 0.00000204513,  C3 = 1.73599 *10^{-7} , C4 = 0.00000388609,}}
\MapleOutput{ C5 = 0.0000101698, L1 = 0.0000334204, L2 = 0.00000193526, L3 = 0.0000227988, L4 = 0.00000101846, }
\MapleOutput{L5 = 3.89179 *10^{-7} ,}
\MapleOutput{R0 = 1, R1 = 0.335978, R2 = 0.0194554, R3 = 0.229198, R4 = 0.0102387, R5 = 0.00391246, Rz = 1.004}
\section{Závěr}
...
\bibitem{11}
\textit{RLC High-Pass Filter Design Tool}. OKAWA Electric Design [online]. 2019 [cit. 2019-05-18]. Dostupné z: \url{http://sim.okawa-denshi.jp/en/RLChikeisan.htm}
\bibitem{12}
