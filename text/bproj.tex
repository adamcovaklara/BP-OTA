...
\MapleOutput{C_{L1} = 3.080024064*10^{-9}, C_{L2} = 1.783535616*10^{-10}, C_{L3} = 2.101137408 *10^{-9}, C_{L4} = 9.38612736*10^{-11},}
\MapleOutput{C_{L5} = 3.586673664*10^{-11}},
\noindent tedy $C_{L1} = 3.08002$ nF, $C_{L2} = 178.35356$ pF, $C_{L3} = 2.10114$ nF, $C_{L4} = 93.86127$ pF, $C_{L5} = 35.86674$ pF.
...
\end{align}
\noindent Kapacity vyšly odnormovány již se Syntfilu $C1 = 118.426$ nF, $C2 = 2.04513$ uF,  $C3 = 173.599$ nF, $C4 = 3.88609$ uF, $C5 = 10.1698$ uF.
