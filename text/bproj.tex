...
\end{figure}
\noindent Řád fitru byl určen jako $order = 4$. Dále byla funkcí $Cauer_asnew$ určena nová hodnota útlumu v nepropustném pásmu NDP.
\begin{align}
...
\MapleOutput{asnew := 83.36289}
\MapleOutput{Gc, poles, zeros := 457.20673,}
