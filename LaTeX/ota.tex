...
\scalebox{0.9}{%
  \begin{tabular}{ | c | >{\centering\arraybackslash}p{1.25cm}| >{\centering\arraybackslash}p{1.25cm} | >{\centering\arraybackslash}p{1.25cm} | >{\centering\arraybackslash}p{1cm} | >{\centering\arraybackslash}p{1cm} | >{\centering\arraybackslash}p{1.25cm} | >{\centering\arraybackslash}p{1.2cm} | >{\centering\arraybackslash}p{1.35cm} |>{\centering\arraybackslash}p{1.2cm} |>{\centering\arraybackslash}p{1cm} |}
    ...
    OPA615ID & 710 MHz & 2.5 kV/$\upmu$s & 5 mA & 3 $\upmu$A & 40 mV & 13 mA & 65 mA/V & 8--12.4 V & 710 MHz & 285.22 Kč Kč\\ \hline
    OPA860ID & 470 MHz & 3.5 kV/$\upmu$s & 15 mA & 5 $\upmu$A & 12 mV & 11.2 mA & 80 mA/V & 5--13 V & 470 MHz & 168.22 Kč\\ \hline
    OPA861ID & 400 MHz & 900 V/$\upmu$s & 15 mA & 1 $\upmu$A & 12 mV & 5.4 mA & 65 mA/V & 4--12.6 V & 80 MHz & 82.68 Kč\\ \hline
     LT1228CS8\#PBF & 100 MHz & 500 V/$\upmu$s & 65 mA & 0.4$\upmu$A  & 3 mV & 9 mA  & 0.75 mA/V & 4--36 V & 80 MHz &  210.34 Kč\\
    \hline
  \end{tabular}}
...
\scalebox{0.9}{%
  \begin{tabular}{ | c | >{\centering\arraybackslash}p{1.25cm}| >{\centering\arraybackslash}p{1.25cm} | >{\centering\arraybackslash}p{1.25cm} | >{\centering\arraybackslash}p{1cm} | >{\centering\arraybackslash}p{1cm} | >{\centering\arraybackslash}p{1.3cm} | >{\centering\arraybackslash}p{1.4cm} | >{\centering\arraybackslash}p{1.25cm} |>{\centering\arraybackslash}p{1.25cm} |>{\centering\arraybackslash}p{1cm} |}
    ...
    LM13700M & 2 MHz & 50 V/$\upmu$s & 650 $\upmu$A & 5 $\upmu$A & 4 mV & 1.3 mA & 6700 $\upmu$S & 10--36 V & 80--110 dB & 32.50 Kč \\ \hline
    NE5517DG & 2 MHz & 50 V/$\upmu$s & 650 $\upmu$A & 5 $\upmu$A & 5 mV & 2.6 mA & 5400 $\upmu$S & 4--44 V & 80 dB & 43.42 Kč \\ \hline
    AU5517DR2G & 2 MHz & 50 V/$\upmu$s & 650 $\upmu$A & 5 $\upmu$A & 5 mV & 2.6 mA & 5400 $\upmu$S & 4--44 V & 80 dB & 64.48 Kč \\ \hline
    NJM13600M & 2 MHz & 50 V/$\upmu$s & 650 $\upmu$A & 5 $\upmu$A & 5 mV & 2.6 mA & 6700 $\upmu$S & 36 V & 80 dB & 36.92 Kč \\ \hline
    NJM13700M & 2 MHz & 50 V/$\upmu$s & 650 $\upmu$A & 5 $\upmu$A & 4 mV & 2.6 mA & 6700 $\upmu$S & 36 V & 80 dB & 37.70 Kč \\ \hline
  \end{tabular}}
